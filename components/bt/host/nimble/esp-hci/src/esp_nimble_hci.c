...
extern uint8_t ble_hs_enabled_state; // https://github.com/espressif/esp-idf/issues/11771
...
static int host_rcv_pkt(uint8_t *data, uint16_t len)
{
    ...
    if(!ble_hs_enabled_state) { // https://github.com/espressif/esp-idf/issues/11771
